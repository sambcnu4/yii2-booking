Contributing to bootstrap-checkbox-x
====================================
Looking to contribute something to bootstrap-checkbox-x? **Here's how you can help.**
...
[plugin documentation](http://plugins.krajee.com/checkbox-x), 
[plugin demos](http://plugins.krajee.com/checkbox-x/demo), and / or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with bootstrap-checkbox-x
----------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within bootstrap-checkbox-x_.
...
- What version of jQuery are you using? And what version of bootstrap-checkbox-x?
- Are you using bootstrap-checkbox-x with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in bootstrap-checkbox-x
------------------------------------------
Before starting work on a major feature for bootstrap-checkbox-x, **read the
[documentation](http://plugins.krajee.com/checkbox-x)  first** or you may risk spending a considerable amount of
...
bootstrap-checkbox-x regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to bootstrap-checkbox-x that contain test cases and
...
It should also be made clear that **all code contributed to bootstrap-checkbox-x** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[isolated-case]: https://jsfiddle.net/
[issue-search]: https://github.com/kartik-v/bootstrap-checkbox-x/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/bootstrap-checkbox-x/issues
[licensing]: https://github.com/kartik-v/bootstrap-checkbox-x/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-bootstrap-checkbox-x
[requesting-features]: #requesting-features-in-bootstrap-checkbox-x