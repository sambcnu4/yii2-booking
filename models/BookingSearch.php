...
class BookingSearch extends Booking
{
    ...
    public function rules()
    {
        return [
            ...
            [['booking_no', 'booking_start', 'booking_end', 'booking_user', 'booking_tel', 'booking_title', 'booking_description', 'booking_cur_date', 'eqipment_notebook', 'eqipment_visualizer', 'eqipment_projector', 'eqipment_tv', 'eqipment_mic1', 'eqipment_mic2', 'eqipment_sound_record', 'eqipment_vdo_record', 'eqipment_photo_record', 'file'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'booking_no', $this->booking_no])
            ->andFilterWhere(['like', 'booking_start', $this->booking_start])
